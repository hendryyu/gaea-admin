...
public class ProductPicture implements Serializable {
    ...
    public ProductPicture(Integer id, String pictureName, int enable, String createdBy, Date createdDate) {
        this.id = id;
    ...
    public String toString() {
        return "com.hy.gaeaadmin.model.entity.ProductPicture[ id=" + id + " ]";
    }
